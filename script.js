window.addEventListener('load', function(){
    ...
    class Particle{
        ...
        draw(context){
            context.drawImage(this.image,this.frameX * this.spriteSize, this.frameY 
                * this.spriteSize, this.spriteSize, this.spriteSize, this.x, this.y,
                this.size, this.size);
        }
    ...
    class Player{
        ...
        update(deltaTime){
            ...
            this.y += this.speedY;
            //vertical boundaries
            if (this.y > this.game.height - this.height) this.y = this.game.height -
            this.height;
    ...
    class UI{
       ...
       draw(context){
        ...
        if (this.game.gameOver){
            ...
            context.font = '100px ' + this.fontFamilly;
